  ...
  },
  {
    ...
    render: (text) => (
      <>
        <div className="flex">
          {text >= 2 ? (
            <button className="bg-blue-500 hover:bg-blue-700 text-white font-bold w-full mr-4 py-2 rounded">
              Accepted
            </button>
          ) : text < 3 ? (
            <button className="bg-red-500 hover:bg-red-700 text-white font-bold w-full  mr-4 py-2 rounded">
              Pending
            </button>
          ) : (
            <></>
